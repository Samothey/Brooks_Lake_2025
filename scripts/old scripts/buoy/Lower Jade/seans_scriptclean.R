...
# Weather ---------------------------------------------------------------------
weather <- read.csv("/Users/seanbertalot/Desktop/2025/Brooks Weather/BrooksWeather_2025.csv", skip = 1, header = T) %>% 
...
# Dissolved Oxygen -------------------------------------------------------------
do_surface <- read.table("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/DO/LJ_surface.txt", sep=",", header=TRUE, skip = 7) %>% 
  slice(-1) %>% 
...
do_depth <- read.table("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/DO/LJ_depth.txt", sep=",", header=TRUE, skip = 7) %>% 
  slice(-1) %>% 
...
# PAR --------------------------------------------------------------------------
par <- read.table("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/PAR/LJ_PAR.txt", sep = ",", header = T, skip = 4) %>% 
  slice(-1) %>% 
...
temp_2m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_2m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("2m") # runs the function while reading in the data, everything happens all at once
temp_4m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_4m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("4m")
temp_5m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_5m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("5m")
temp_6m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_6m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("6m")
temp_7m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_7m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("7m")
temp_8m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_8m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("8m")
temp_10m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_10m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("10m")
temp_11m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_11m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("11m")
temp_12m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_12m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("12m")
temp_13m <- read.csv("/Users/seanbertalot/Desktop/2025/Lower Jade/Raw Data/Temp/LJ_13m.csv", skip = 1, header = TRUE) %>% 
  clean_pendant("13m")
...
write.csv(lower_jade, "/Users/seanbertalot/Desktop/2025/lower_jade.csv") # Writes to csv
